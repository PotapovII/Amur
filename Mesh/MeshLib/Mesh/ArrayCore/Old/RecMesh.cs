...
//        /// </summary>
//        public double[] GetCoords(int dim) => triMesh.GetCoords(dim);
//        /// <summary>
...
//        public void ElemX(uint i, ref double[] X) => triMesh.ElemX(i, ref X);
//        /// <summary>
//        /// Получить координаты Y вершин КЭ
//        /// </summary>
//        /// <param name="i">номер элемента</param>
//        /// <returns>Координаты Y вершин КЭ</returns>
//        public void ElemY(uint i, ref double[] Y) => triMesh.ElemY(i, ref Y);
//        /// <summary>
...
//        {
//            return triMesh.GetBoundElementsType();
//        }
...
//        }
//        #endregion
//        public RecMesh(int imax,int jmax, double xa, double xb, double ya, double yb)
//        {
//            this.imax = imax;
//            this.jmax = jmax;
//            Nx = imax + 1;
...
//        }
//        public RecMesh(RecMesh mesh)
//        {
//            SetMesh(mesh);
//            triMesh = GetMesh();
//        }
//        public RecMesh(IMesh mesh)
//        {
//            RecMesh m = mesh as RecMesh;
//            if (m != null)
//            {
//                SetMesh(m);
//                triMesh = GetMesh();
...
//        public void SetMesh(RecMesh mesh)
//        {
//            imax = mesh.imax;
//            jmax = mesh.jmax;
//            Nx = mesh.Nx;
