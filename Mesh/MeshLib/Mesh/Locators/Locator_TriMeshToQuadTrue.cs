...
namespace MeshLib
{
    ...
    /// </summary>
    public class Locator_TriMeshToQuadTrue
    {
        /// <summary>
        /// Сетка источник
        /// </summary>
        ...
        /// Сетка приемник 
        /// </summary>
        public RectFVMesh QMesh => qmesh;
        /// <summary>
        /// Сетка приемник
        /// </summary>
        RectFVMesh qmesh = null;
        /// <summary>
        /// Связи между узлами QMesh и КЭ TriMesh
        /// </summary>
        ...
        double ya = 0;
        double yb = 0;
        public Locator_TriMeshToQuadTrue(IMesh mesh)
        {
            this.mesh = mesh;
            ...
            if (m != null)
            {
                ...
                double[] xt = { 1, 1, 2, -3, -3, 4, 2 };
                int CountX = MEM.CountUniqueElems(xt);
