...
namespace MeshLib
{
    ...
    public class KsiMesh : ComplecsMesh
    {
        ...
        public int[][] CVolumes;
        /// <summary>
        /// Лист связности внутренних КО, за исключением граничных 
        /// узлов и узлов, где ставится WallFunc
        /// </summary>
        public int[][] CV2 = null;
        /// <summary>
        ...
        public KsiMesh(KsiMesh m) : base(m)
        {
            ...
            MEM.MemCopyNull(ref Ycr, m.Ycr);
            MEM.MemCopyNull(ref Ycr, m.Ycr);

            MEM.MemCopyNull(ref S, m.S);
            MEM.MemCopy(ref S0, m.S0);

            MEM.MemCopyNull(ref Lk, m.Lk);
            MEM.MemCopyNull(ref Nx, m.Nx);
            MEM.MemCopyNull(ref Ny, m.Ny);

            MEM.MemCopyNull(ref Lx10, m.Lx10);
            MEM.MemCopyNull(ref Lx32, m.Lx32);
            MEM.MemCopyNull(ref Ly01, m.Ly01);
            MEM.MemCopyNull(ref Ly23, m.Ly23);

            MEM.MemCopyNull(ref Alpha, m.Alpha);
            MEM.MemCopyNull(ref P1, m.P1);
        ...
        public KsiMesh(ComplecsMesh m) : base(m)
        {
            ...
            TriangleGeometryCalculation(structureChanged);
            MakeWallFuncStructure(surf_flag);
        }
        ...
        protected void Initializing()
        {
            ...
            MEM.VAlloc(5 * CountBottom, -1, ref BottomTriangles);
            MEM.VAlloc(5 * CountBottom, -1, ref TopTriangles);

           // MEM.Alloc(CountRight - 2, ref CPLeft);
        ...
        public void TransportCVstructure(KsiMesh prevMesh)
        {
            if (prevMesh != null)
            {
