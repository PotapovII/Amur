...
namespace MeshGeneratorsLib
{
    ...
    /// </summary>
    public class DiffMeshBuilder : AMeshBuilder
    {
        /// <summary>
        /// Название строителя КЭ сетки
        /// </summary>
        public override string Name => "Решение НЭУ для координат узлов";


        double RelaxMeshOrthogonality;
        public DiffMeshBuilder(double RelaxMeshOrthogonality = 0.1)
        {
