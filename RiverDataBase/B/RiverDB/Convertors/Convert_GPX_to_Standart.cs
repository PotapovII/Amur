namespace RiverDB.Convertors
{
    ...
    public class Convert_GPX_to_Standart
    {
        ...
        public static void AddRow(int ID, DataRow r)
        {
            ...
            string ss = ID.ToString() + " " + s0 + " " + s1 + " " + s2 + " " + s3 +
                " " + s4 + " " + s5 + " " + s6 + " " + s7 + " " + s8 + " " + s9;
        ...
        static List<IStandartSQLCommand> list = new List<IStandartSQLCommand>();
        public static List<IStandartSQLCommand> LoadExcel(string name)
        {
            list.Clear();
            ConnectDB.LoadExcel(name, AddRow);
            return list;
        }
        //public static List<IStandartSQLCommand> LoadExcel(string name)
        //{
