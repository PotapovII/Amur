...
namespace NPRiverLib.APRiver1YD.Params
{
    ...
    /// </summary>
    public class RiverStreamQuadParams : ITProperty<RiverStreamQuadParams>
    {
        /// <summary>
        ...
        public RiverStreamQuadParams Clone(RiverStreamQuadParams p)
        {
            return new RiverStreamQuadParams(p);
        }
    }
