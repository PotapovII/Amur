...
namespace NPRiverLib.APRiver2XYD.River2DFST
{
    ...
    /// </summary>
    [Serializable]
    public class GasDynamics_FCT : ARiverSWE_FCT_2XYD
    { 
        #region поля задачи
        ...
        double[] b_rho = null, b_p = null, b_T = null;
        #endregion
       ...
       // public IMesh Mesh() => mesh.Clone();
        ...
        {
            return new GasDynamics_FCT(Params);
        }
        ...
        {
            RectangleMeshTri rMesh = new RectangleMeshTri(Lx, Ly, Nx, Ny, BCMark);
            mesh = rMesh;
            dx = rMesh.dx;
            dy = rMesh.dy;
