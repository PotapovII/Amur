...
namespace NPRiverLib.APRiver2XYD.River2DSW
{
    ...
    [Serializable]
    public abstract class APRiverFEM2XYD : APRiver2XYD<ParamsRiver2XYD>, IRiver
    {
        ...
        public APRiverFEM2XYD(ParamsRiver2XYD p) : base(p) { }
        ...
        /// </summary>
        public void RollbackToOldValues(IRiverNode[] nodes)
        {
            for (int i = 0; i < nodes.Length; i++)
            {
