...
namespace NPRiverLib.APRiver2XYD.River2DSW
{
    ...
    public class BoundSegmentRiver
    {
        ...
        public int ID = 0;
        /// <summary>
        /// значение отметки свободной поверхности на сегменте границы
        /// </summary>
        public double Eta = 0;  // p0
        /// <summary>
        /// значение гу расход нормальный к снгменту границы
        /// </summary>
        public double Qn = 0; // p1
        /// <summary>
        /// Интеграл по КЭ сегмента вида sum_belem( fac H^(5/3) L_belem )
        /// </summary>
        public double DepthCoef = 0; // p2
        /// <summary>
        ...
        public static BoundSegmentRiver Parse(string[] lines)
        {
            ...
            segment.Eta = double.Parse(lines[4].Trim(), MEM.formatter);
