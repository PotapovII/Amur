...
namespace NPRiverLib.APRiver_2XYD.River2DSW
{
    ...
    /// </summary>
    [Serializable]
    public class TriRiverSWE_2XYD : APRiverFEM_2XYD
    {
        /// <summary>
        /// ограничители для ГУ
        /// </summary>
        ...
        public TriRiverSWE_2XYD() : this(new ParamsRiver_2XYD())
        {
        }
        /// <summary>
        /// Конструктор
        ...
        /// <param name="p">параметры задачи</param>
        /// <param name="algebra">алгебра задачи</param>
        public TriRiverSWE_2XYD(ParamsRiver_2XYD p) : base(p)
        {
            name = "Плановая задача мелкой воды TriRiverSWE_2XYD";
        ...
        public static void Test()
        {
            ...
            IRiver river2D = new TriRiverSWE_2XYD();
