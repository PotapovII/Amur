...
namespace NPRiverLib.APRiver_1XD.River2D_FVM_ke
{
    ...
    [Serializable]
    public abstract class APatankarRiver1XD : APRiver1XD<PatankarParams_1XD>, IRiver
    {
        public APatankarRiver1XD(PatankarParams_1XD p) : base(p) {}
        /// <summary>
        /// Установка параметров
        /// </summary>
        /// <param name="ps">параметры</param>
        public void AllocCalculationDomain()
        {
            imax = Params.FV_X + 1;
            jmax = Params.FV_Y + 1;
            Nx = imax + 1;
        ...
        public override void SetZeta(double[] zeta, BedErosion bedErosion)
        {
            ...
            else
            {
                ...
                // в методе AllocCalculationDomain
        ...
        public void OnBoundCalculate()
        {
            ...
            for (i = 1; i < imax; i++)
            {
                ...
                if ((Params.Wen1 >= bx && Params.V1_inlet < MEM.Error10) ||
                    (Params.Wen2 + Params.Wen1 > bx && Params.Wen1 <= bx && Params.V2_inlet < MEM.Error10) ||
                    (Params.Wen3 + Params.Wen2 + Params.Wen1 + hh > bx && Params.Wen2 + Params.Wen1 <= bx && Params.V3_inlet < MEM.Error10))
                {
