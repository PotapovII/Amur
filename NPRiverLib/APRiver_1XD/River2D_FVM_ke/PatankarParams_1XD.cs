...
namespace NPRiverLib.APRiver_1XD.River2D_FVM_ke
{
    ...
    /// </summary>
    [Serializable]
    public class PatankarParams_1XD : ITProperty<PatankarParams_1XD>
    {
        public int nfmax = 7;
        ///// <summary>
        /// Размерность модели  
        ...
        /// </summary>
        /// <param name="ps"></param>
        public PatankarParams_1XD(PatankarParams_1XD ps)
        {
            Set(ps);
        }
        ...
        /// </summary>
        /// <param name="ps"></param>
        public void Set(PatankarParams_1XD ps)
        {
        ...
        public PatankarParams_1XD Clone(PatankarParams_1XD p)
        {
            return new PatankarParams_1XD(p);
        }
    }
}
