...
namespace NPRiverLib.APRiver_1XD.River2D_FVM_ke
{
    ...
    public class CPatankarStream1XD : APatankarRiver1XD
    {
        ...
        /// </summary>
        /// <param name="ps"></param>
        public CPatankarStream1XD() : this(new PatankarParams_1XD()) { }
        /// <summary>
        /// конструктор
        /// </summary>
        /// <param name="ps"></param>
        public CPatankarStream1XD(PatankarParams_1XD ps) : base(ps)
        {
            name = "Турбулентнй поток (k-e) rho_w = const CPatankarStream1XD";
