...
namespace NPRiverLib.APRiver_1XD.River2D_FVM_ke
{
    ...
    public class VPatankarStream1XD : APatankarRiver1XD
    {
        ...
        /// </summary>
        /// <param name="ps"></param>
        public VPatankarStream1XD() : this(new PatankarParams_1XD()) { }
        /// <summary>
        /// конструктор
        /// </summary>
        /// <param name="ps"></param>
        public VPatankarStream1XD(PatankarParams_1XD ps) : base(ps)
        {
            name = "Турбулентнй поток (k-e) rho_w = var VPatankarStream1XD";
