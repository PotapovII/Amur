...
namespace NPRiverLib.IO
{
    ...
    [Serializable]
    public class TaskReaderEmpty2XYDTri : ATaskFormat<IRiver>
    {
        /// <summary>
        ...
        const string Ext_txt = ".mzt";

        public TaskReaderEmpty2XYDTri()
        {
        ...
        /// <summary>
        /// Прочитать файл, содержащий данные в формате mzt. (mesh2D & zeta & tau...)
        /// </summary>
        /// <param name="filename">Путь к файлу для чтения..</param>
        /// <param name="river">созданные объект</param>
        /// <param name="testID">вариант тестовой задачи</param>
                ...
                try
                {
                    ...
                    using (StreamReader file = new StreamReader(filename))
                    {
                        ...
                        for (int i = 0; i < CountKnots; i++)
                        {
                            ...
                            mesh.CoordsY[i] = double.Parse(slines[1], MEM.formatter);
                            river2D.zeta0[i] = double.Parse(slines[2], MEM.formatter);
