...
namespace TestEliz2D
{
    ...
    public class ManagerOfChildsAreaBed
    {
        /// <summary>
        ...
        public ManagerOfChildsAreaBed()
        {
            ...
            //
            baseType = typeof(AbsBedFormParam);
            //
        ...
        /// <returns></returns>
        public AbsBed CreateDetermChild(int Index)
        {
            try
            {
                return (AbsBed)ListOfChilds[Index].GetConstructor(new Type[] { }).Invoke(new object[] { });
            }
            catch
            {
                return null;
        ...
        //
        public AbsBed CreateDetermChild(int Index, AbsBedFormParam Param)
        {
            try
            {
                return (AbsBed)ListOfChilds[Index].GetConstructor(new Type[] {typeof(AbsBedFormParam) }).Invoke(new object[] { Param});
            }
            catch
            {
                return null;
        ...
        /// <param name="Index">порядковый номер в списке потомков базового класса</param>
        /// <returns></returns>
        public AbsBedFormParam CreateDetermParam(int Index)
        {
            try
            {
                return (AbsBedFormParam)ListOfParameters[Index].GetConstructor(new Type[] { }).Invoke(new object[] { });
            }
            catch
            {
                return null;
        ...
        public void Par(AbsBedFormParam childParameter, out string[] Names, out Type[] Types)
        {
