namespace RiverLib.AllWallFunctions
{
    ...
    public class WallFunction_Nguyen
    {
        ...
        public double u0 = 0;
        protected double ks, Mu, U, Y, tau, yplus;
        ...
        public void Tau_Nguyen(double U, double Y, double ks, double Mu, ref double _tau, ref double _yplus)
        {
            this.Mu = Mu;
            this.U = U;
            this.Y = Y;
        ...
        public static void Test_WallFunction_Nguyen()
        {
            ...
            double U = u0 / kappa * Math.Log(Y_plus) + C * u0 - u0 / kappa * Math.Log(1 + ks_plus / Math.Exp(3.25 * kappa));
            Console.WriteLine("U = {4} Y_plus = {0}, ks_plus = {1} u0 = {2} Tau = {3}, Tau_y = {5}", Y_plus, ks_plus, u0, Tau, U, Tau_y);
            double tau = 0;
            double yplus = 1;
            fw.Tau_Nguyen(U, Y, ks, Mu, ref tau, ref yplus);
