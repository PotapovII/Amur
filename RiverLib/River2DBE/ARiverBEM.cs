...
namespace RiverLib
{
    ...
    [Serializable]
    public abstract class ARiverBEM : IRiver
    {

        #region Параметры задачи
        protected RiverBECircleParams Params = new RiverBECircleParams();
        /// <summary>
        ...
        {
            RiverBECircleParams pp = p as RiverBECircleParams;
            SetParams(pp);
        }
        public void SetParams(RiverBECircleParams p)
        {
            Params = new RiverBECircleParams(p);
        }
        ...
        {
            Params = new RiverBECircleParams();
            //Params.Load(file);
        }
        #endregion
        ...
        /// </summary>
        public virtual string VersionData() => "RiverBECircle 01.09.2021/14.02.2022"; 
        /// <summary>
        /// Текущее время
        /// </summary>
        ...
        /// Конструктор
        /// </summary>
        public ARiverBEM(RiverBECircleParams p) 
        {
            SetParams(p);
            green = new Green();
            Log2 = Math.Log(2);
