...
namespace RiverLib
{
    ...
    [Serializable]
    public class RiverBECircleNewMeshAdapt : RiverBECircleNewMesh
    {
        /// <summary>
        ...
        {
            return new RiverBECircleNewMeshAdapt(new RiverBECircleParams());
        }
        /// <summary>
        /// версия дата последних изменений интерфейса задачи
        /// </summary>
        public override string VersionData() => "RiverBECircleNewMeshAdapt 01.04.2022"; 
        /// <summary>
        /// Конструктор
        /// </summary>
        public RiverBECircleNewMeshAdapt(RiverBECircleParams p) : base(p)
        {
            name = "поток под трубой (МГЭ) н.в. с сеткой и 0 циркуляцией";
            InitTask();
        }
        /// <summary>
