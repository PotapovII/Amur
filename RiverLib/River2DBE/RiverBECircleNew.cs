...
namespace RiverLib
{
    ...
    [Serializable]
    public class RiverBEMCircle : ARiverBEM
    {
        /// <summary>
        ...
        {
            return new RiverBEMCircle(new RiverBECircleParams());
        }
        /// <summary>
        /// версия дата последних изменений интерфейса задачи
        /// </summary>
        public override string VersionData() => "RiverBEMCircle 01.09.2021/26.02.2022"; 
        /// <summary>
        ...
        /// Конструктор
        /// </summary>
        public RiverBEMCircle(RiverBECircleParams p) : base(p)
        {
            name = "гидрадинамика потока под трубой (МГЭ) новый вариант"; 
            InitTask();
        }
        /// <summary>
