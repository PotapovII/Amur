...
//    /// </summary>
//    [Serializable]
//    public abstract class ARiver<TParam> : IRiver  where TParam : IPropertyTask
//    {
//        /// <summary>
//        /// версия дата последних изменений интерфейса задачи
//        /// </summary>
//        public string VersionData() => "ARiver 04.04.2024";

//        #region Параметры задачи
//        /// <summary>
//        /// Параметры задачи
//        /// </summary>
//        protected TParam Params;
//        /// <summary>
...
//        {
//            TaskFileNames fn = new TaskFileNames(GetFormater());
...
//        /// </summary>
//        public virtual TypeTask TypeTask { get => typeTask; }
//        protected TypeTask typeTask = TypeTask.streamX1D;
//        /// <summary>
//        /// Текущее время
//        /// </summary>
...
//        protected IUnknown[] unknowns = { new Unknown("Средняя скорость потока", true, TypeFunForm.Form_1D_L1),
//                                          new Unknown("Средняя глубина потока", true, TypeFunForm.Form_1D_L1) };
//        #endregion
//        /// <summary>
//        /// средняя скорость
//        /// </summary>
