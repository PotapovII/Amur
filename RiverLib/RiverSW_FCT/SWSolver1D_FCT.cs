...
namespace RiverLib
{
    public class SWSolver1D_FCT
    {
        ...
        public int main(int argc, string[] argv)
        {
            ...
            Console.WriteLine("SHALLOW_WATER_1D");
            ...
            {
                x_length = double.Parse(argv[3]);
            }
            Console.WriteLine("  X_LENGTH = {0}", x_length);
            ...
            {
                t_length = double.Parse(argv[4]);
            }
            Console.WriteLine("  T_LENGTH = {0}", t_length);
        ...
        //
        {
            ...
            for (j = 0; j < n; j++)
            {
                for (i = 0; i < m; i++)
                {
                    Console.Write("  " + table[i + j * m].ToString("F6"));
        ...
        //        static string time_buffer[TIME_SIZE];
