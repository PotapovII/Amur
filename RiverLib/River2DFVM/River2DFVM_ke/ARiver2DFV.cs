...
namespace RiverLib.Patankar
{
    ...
    public abstract class ARiver2DFV : IRiver
    {
        ...
        {
            SetParams((Stream2FVParams)p);
        }
        /// <summary>
        /// установка параметров
        /// </summary>
        public void SetParams(Stream2FVParams p)
        {
            Params = new Stream2FVParams(p);
            InitTask();
        }
        /// <summary>
        /// установка параметров
        ...
        protected IUnknown[] unknowns = { new Unknown("Осредненная скорость х", null,TypeFunForm.Form_2D_Rectangle_L1),
                                          new Unknown("Осредненная скорость у", null, TypeFunForm.Form_2D_Rectangle_L1),
                                          new Unknown("Давление ", null, TypeFunForm.Form_2D_Rectangle_L1),
                                          new Unknown("Поправка давления", null, TypeFunForm.Form_2D_Rectangle_L1),
                                          new Unknown("Кинетичесая энергия турбулентности", null, TypeFunForm.Form_2D_Rectangle_L1),
                                          new Unknown("Диссипация кинетической энергии турбулентности",null, TypeFunForm.Form_2D_Rectangle_L1),
                                          new Unknown("Температура потока", null, TypeFunForm.Form_2D_Rectangle_L1) };
        ...
        public virtual void Set(Stream2FVParams ps)
        {
            ...
            Nx = imax + 1;
            Ny = jmax + 1;
            //this.wavePeriod = ps.wavePeriod;
            //this.bottomWaveAmplitude = ps.bottomWaveAmplitude;
            //x = new double[Nx][];
            //xu = new double[Nx][];
            //Dx = new double[Nx][];
            //for (int i = 0; i < Nx; i++)
        ...
        public void CreateStaticBedForms(ref double[] zeta)
        {
            ...
            qmesh.GetZetaArea(ref count, ref In, ref Out, Params.Len1, Params.Len2, false);
