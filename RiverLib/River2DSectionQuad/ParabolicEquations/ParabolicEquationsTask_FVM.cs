...
{
    /// <summary>
    /// Решение парболического уравнения прямыми методами
    /// основе библиотеки линейной алгебры 
    /// </summary>
    public class ParabolicEquationsTask_FVM
    {
        /// <summary>
        /// Плотность воды
        /// </summary>
        ...
        public ParabolicEquationsTask_FVM(ARectangleMesh mesh,
        ...
        #region Вычисление вторичных полей
        /// <summary>
        ...
        /// <param name="mX"></param>
        /// <param name="X"></param>
        protected void Solve(ref double[][] mX, ref double[] X)
        {
            try
            {
                if (Debug == true)
        ...
        public void TaskSolve(double[][] nu, double[][] Sc, ref double[][] mX, ref double[] X)
        {
            Start();
            CalkAk(nu);
            CalkRight(Sc);
