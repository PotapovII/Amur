...
namespace RiverLib
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ASectionalRiverTaskQuad : IRiver
    {
        ...
        public ASectionalRiverTaskQuad(RiverStreamParams p) 
        {
            SetParams(p);
            Init();
        }
        ...
        /// <param name="flagBLoad">флаг генерация сетки при размывах дна</param>
        ...
        public void Scan()
        {
            TaskEvolution te = new TaskEvolution(time, Mu,
                                waterLevel, tauMax, tauMid, GR, Area, 
                                riverFlowRate, riverFlowRateCalk);
            evolution.Add(te);
        }
        /// <summary>
