...
//    public class Solver
//    {
//        protected HabitatTIN theMeshP;
//        protected double Pen;
//        public Solver(HabitatTIN meshP)
//        {
//	        theMeshP = meshP;
//	        Pen = 0;
//        }

//        protected void matrixVectorMult(double[] InVec, double[] OutVec, ItemList[] ElMtxL, ItemList[] BElMtxL, int nVars)
//        {
...
//        protected void assembleRHS(double[] RHS, ItemList[] ElMtxL, ItemList[] BElMtxL, int nVars)
//        {
//            int n, nn, outVectrow;
//            ElementMtx* elMP, *BelMP;
//            Element* elP, *belP;
...
//        protected void MInverse(double[] PreCon, ItemList[] ElMtxL, ItemList[] BElMtxL, int nVars)
//        {
//            int n, nn, outVectrow;
//            ElementMtx* elMP, *BelMP;
//            Element* elP, *belP;
...
//        public void conjugateGradients(ItemList[] ElMtxL, ItemList[] BElMtxL, int nVars)
//        {
...
//        }
//        public void preconditionedCGs(ItemList[] ElMtxL, ItemList[] BElMtxL, int nVars)
//        {
...
//            theMeshP.updateSolToNodes(X);
//        }
//        public void preconditionedGMRES(ItemList[] ElMtxL, ItemList[] BElMtxL, int nVars, int m, int k, double rec)
//        {
