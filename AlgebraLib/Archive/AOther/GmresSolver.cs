...
namespace AlgebraLib.CG
{
    ...
    public static class GmresSolver
    {
        ...
        public static GmresResult Solve(double[][] A, double[] b, int? maxInnerIterations = null, 
                                        int? maxOuterIterations = null, double epsilon = DefaultEpsilon, 
                                        double[] x0 = null, int? degreeOfParallelism = null)
        {
            ...
            return new GmresResult(x, false, maxOuterIterations.Value, 
                                    maxInnerIterations.Value, errors.ToArray());
        }
