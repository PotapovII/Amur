...
namespace AlgebraLib.Sparse.River
{
    ...
    using CommonLib;
    using MemLogLib;
    public class SparseMatrixSolver : ASparseMatrixSolver, IAlgebra
    {
        /// <summary>
        ...
        public SparseMatrixSolver(uint numRows, int rowSize, int isPrecond, 
        ...
        // Copy constructor
        public SparseMatrixSolver(SparseMatrixSolver algebra) : base(algebra) 
        { 
        ...
        public SparseMatrixSolver() : base(1,20) 
        { 
            name = "GMRES (CSR matrix)";
            EPS = MEM.Error9;
        }
        ...
        {
            return new SparseMatrixSolver(this);
        }
        /// <summary>
