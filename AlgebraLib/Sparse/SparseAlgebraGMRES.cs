...
namespace AlgebraLib
{
    ...
    /// </summary>
    public class SparseAlgebraGMRES : SparseAlgebra
    {
        ...
        protected uint M;
        #endregion
        public SparseAlgebraGMRES(uint FN, uint M = 10, bool isPrecond = false) : base(FN, isPrecond)
        {
            this.M = M;
        ...
        {
            return new SparseAlgebraGMRES(this.N, this.M);
        }
