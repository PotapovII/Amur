namespace ViewerGL
{
    ...
    public struct RectangleWorld
    {
        ...
        {
            int merror = 4;
            bool r = Equals(a.Left, b.Left, merror) &&
                     Equals(a.Right, b.Right, merror) &&
                     Equals(a.Top, b.Top, merror) &&
                     Equals(a.Bottom, b.Bottom, merror);
            return r;
        }
        public static bool operator !=(RectangleWorld a, RectangleWorld b)
        {
        ...
        public static bool Equals(float a, float b, double eps = 0.000001)
        {
            if (Math.Abs(a - b) < eps)
                return true;
            else
