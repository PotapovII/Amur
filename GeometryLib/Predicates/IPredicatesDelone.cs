namespace GeometryLib.Predicates
{
    ...
    public interface IPredicatesDelone
    {
        ...
        /// </summary>
        double CounterClockwise(HPoint a, HPoint b, HPoint c);
        /// <summary>
        ...
        /// </summary>
        double InCircle(HPoint a, HPoint b, HPoint c, HPoint p);
        /// <summary>
        ...
        HPoint FindCircumcenter(HPoint org, HPoint dest, HPoint apex, ref double xi, ref double eta);
        /// <summary>
        /// Найдите центр описанной окружности треугольника.
        /// </summary>
        /// <param name="org">Точка треугольника.</param>
        ...
        HPoint FindCircumcenter(HPoint org, HPoint dest, 
                HPoint apex, ref double xi, ref double eta,
                double offconstant);
    }
}