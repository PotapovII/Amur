...
// -----------------------------------------------------------------------
namespace GeometryLib.Predicates
{
    ...
    /// ---------------------------------------------------------------
    public class HPredicatesDelone : IPredicatesDelone
    {
        /// <summary>
        ...
        private static HPredicatesDelone _default;
        /// <summary>
        /// Gets the default configuration instance.
        /// Получает экземпляр конфигурации по умолчанию.
        /// </summary>
        public static HPredicatesDelone Default
        {
            get
            {
                if (_default == null)
                {
                    lock (creationLock)
                    {
                        if (_default == null)
                        {
                            _default = new HPredicatesDelone();
                        }
                    }
                }
                return _default;
        ...
        /// 
        /// </summary>
        /// <param name="pa">HPoint a.</param>
        /// <param name="pb">HPoint b.</param>
        /// <param name="pc">HPoint c.</param>
        ...
        /// </returns>
        public double CounterClockwise(HPoint pa, HPoint pb, HPoint pc)
        {
        ...
        public double InCircle(HPoint pa, HPoint pb, HPoint pc, HPoint pd)
        {
        ...
        /// pa, pb, and pc; a negative value if it lies outside; and zero if the four points 
        /// are cocircular.</returns>
        public double NonRegular(HPoint pa, HPoint pb, HPoint pc, HPoint pd)
        {
        ...
        public HPoint FindCircumcenter(HPoint org, HPoint dest, HPoint apex,
            ref double xi, ref double eta, double offconstant)
        {
            ...
            return new HPoint(org.x + dx, org.y + dy);
        }
        ...
        /// Эта процедура также возвращает квадрат длины самого короткого ребра 
        /// треугольника.
        /// </remarks>
        public HPoint FindCircumcenter(HPoint org, HPoint dest, HPoint apex,
        ...
        /// </remarks>
        private double CounterClockwiseAdapt(HPoint pa, HPoint pb, HPoint pc, double detsum)
        {
        ...
        /// Следовательно, эта функция обычно работает довольно быстро, но будет работать медленнее, 
        /// если входные точки совпадают или почти совпадают.
        private double InCircleAdapt(HPoint pa, HPoint pb, HPoint pc, HPoint pd, double permanent)
        {
            double adx, bdx, cdx, ady, bdy, cdy;
            double det, errbound;
