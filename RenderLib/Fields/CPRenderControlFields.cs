...
namespace RenderLib
{
    ...
    /// </summary>
    public class CPRenderControlFields : Control, IProxyRendererFields
    {
        /// <summary>
        ...
        /// </summary>
        TaskRendererFields taskRenderer;
        /// <summary>
        /// Настройка цветовой схемы изображения
        /// </summary>
        ColorSchemeFields colors = new ColorSchemeFields();
        /// <summary>
        /// Опции отрисовки 
        /// </summary>
        ...
        public void SetData(SavePointData data)
        {
            ...
            this.data = data;
            taskRenderer = new TaskRendererFields(data);
