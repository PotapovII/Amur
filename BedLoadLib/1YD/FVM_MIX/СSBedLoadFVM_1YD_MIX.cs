...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class СSBedLoadFVM_1YD_MIX : ABedLoadFVM_1YD_MIX
    {
        public override IBedLoadTask Clone()
        {
            return new СSBedLoadFVM_1YD_MIX(new BedLoadParams1D_MIX());
        }
        /// <summary>
        ...
        public СSBedLoadFVM_1YD_MIX() : this(new BedLoadParams1D_MIX ())
        {
        }
        public СSBedLoadFVM_1YD_MIX(BedLoadParams1D_MIX p) : base(p)
        {
        ...
        /// </summary>
        public override void CalkZetaFDM(ref double[] Zeta, double[] tau, 
                double[] tauY = null, double[] P = null, double[][] CS = null)
        {
            try
            {
                ...
                for (int i = 0; i < N; i++)
                {
                    ...
                    for (int fr = 0; fr < ParamsEx.CountMix - 1; fr++)
                    {
                        ...
                        Gf[i][fr] = - ParamsEx.Elems_FractionSurface[i][fr] * G0[i] * Bf[i][fr] * dz;
                        A[i] += Af[i][fr];
                        B[i] += Bf[i][fr];
                    }
                ...
                if (ParamsEx.BCondIn.typeBC == TypeBoundCond.Neumann)
                {
                    ...
                    S[0] = ParamsEx.BCondIn.valueBC - Gtran_in;
                }
        ...
        public static void Test0()
        {
           ...
           // BedLoadParams1D_MIX bedMixModelParams = new BedLoadParams1D_MIX(blp);

            СSBedLoadFVM_1YD_MIX mblp = new СSBedLoadFVM_1YD_MIX(blp);
            СSBedLoadFVM_1YD_MIX bltask = new СSBedLoadFVM_1YD_MIX(blp);
