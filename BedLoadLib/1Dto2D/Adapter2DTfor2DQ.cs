...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class Adapter2DTfor2DQ : ABedLoadFEM_2D
    {
        /// <summary>
        ...
        {
            return new Adapter2DTfor2DQ(Params);
        }
        ...
        /// Конструктор 
        /// </summary>
        public Adapter2DTfor2DQ(BedLoadParams2D p) : base(p)
        {
            cu = 3;
