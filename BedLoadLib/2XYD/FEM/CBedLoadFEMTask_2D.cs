...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class CBedLoadFEMTask_2D : ABedLoadFEM_2D
    {
        /// <summary>
        ...
        {
            return new CBedLoadFEMTask_2D(Params);
        }
        /// <summary>
        ...
        public CBedLoadFEMTask_2D() : this(new BedLoadParams2D()) { }
        /// <summary>
        /// Конструктор 
        /// </summary>
        public CBedLoadFEMTask_2D(BedLoadParams2D p) : base(p)
        {
            double s = SPhysics.PHYS.s;
            ss = (1 + s) / s;
            //MEM.Alloc<uint>(cu, ref knots);
            //MEM.Alloc<double>(cu, ref zeta);
            //MEM.Alloc<double>(cu, ref press);
            //MEM.Alloc<double>(cu, ref Tx);
            //MEM.Alloc<double>(cu, ref Ty);
            //double[,] _MM = { { 2, 1, 1 }, { 1, 2, 1 }, { 1, 1, 2 } };
            //MM = _MM;   
        ...
        public override void CalkCoeff(uint elem, double mtauS, double dZx, double dZy)
        {
            ...
            else
            {
                ...
                if (Params.blm != TypeBLModel.BLModel_1991)
                {
                    ...
                    {
                        dPX += ff.DN_x[ai] * press[ai] / (rho_b * GRAV);
                        dPY += ff.DN_y[ai] * press[ai] / (rho_b * GRAV);
                    }
        ...
        public override void CalkZetaFDM(ref double[] Zeta, double[] tauX, double[] tauY, double[] P = null, double[][] CS = null)
        {
            try
            {
                ...
                if (Params.isAvalanche == AvalancheType.AvalancheQuad_2021)
        ...
        {
            double tau0 = SPhysics.PHYS.tau0;
            BedLoadParams2D blp = new BedLoadParams2D();
            CBedLoadFEMTask_2D bltask = new CBedLoadFEMTask_2D(blp);
