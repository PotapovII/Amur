...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class BedLoadTask2DFVM : ABedLoadFEM_2D
    {
        public override IBedLoadTask Clone()
        {
            return new BedLoadTask2DFVM(Params);
        }
        /// <summary>
        ...
        /// Конструктор 
        /// </summary>
        public BedLoadTask2DFVM(BedLoadParams2D p) : base(p)
        {
        ...
        public override void SetTask(IMesh mesh, double[] Zeta0, double[] Roughness, IBoundaryConditions BConditions)
        {
            ...
            try
            {
                ...
                #region подавление base.SetTask ABedLoadFEM_2D (дабы не выделять память дважды)
