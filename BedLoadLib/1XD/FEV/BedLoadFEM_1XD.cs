...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class BedLoadFEM_1XD : ABedLoadFEM_1XD
    {
        /// <summary>
        ...
        {
            return new BedLoadFEM_1XD(new BedLoadParams1D());
        }
        /// <summary>
        ...
        /// Конструктор 
        /// </summary>
        public BedLoadFEM_1XD() : this(new BedLoadParams1D()) { }
        public BedLoadFEM_1XD(BedLoadParams1D p) : base(p)
        {
            cu = 2;
            MEM.Alloc(cu, ref a, "a");
            MEM.Alloc(cu, ref b, "b");
            name = "деформация дна FEM (d50) T(U-Uc)";
        }
        /// <summary>
        ...
        public static void Test0()
        {
            ...
            BedLoadFEM_1XD bltask = new BedLoadFEM_1XD(blp);
