...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class BedLoadFVM_1XD_Z : BedLoadFVM_1XD
    {
        public override IBedLoadTask Clone()
        {
            return new BedLoadFVM_1XD_Z(Params);
        }
        public BedLoadFVM_1XD_Z() : this(new BedLoadParams1D()) { }
        public BedLoadFVM_1XD_Z(BedLoadParams1D p) : base(p)
        {
