...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class BedLoadFVM_1XD : ABedLoadFVM_1XD
    {
        ...
        {
            return new BedLoadFVM_1XD(Params);
        }
        public BedLoadFVM_1XD() : this(new BedLoadParams1D())
        {}
        public BedLoadFVM_1XD(BedLoadParams1D p) : base(p)
        {
            name = "деформация дна FVM (d50) T(U-Uc)";
        }
        /// <summary>
        ...
        public override void Calk_Gs(ref double[][] Gs, ref double[][] dGs, double[] tau, double[] P = null)
        {
            ...
            if (Params.blm == TypeBLModel.BLModel_2010 || 
                Params.blm == TypeBLModel.BLModel_2014 || 
                Params.blm == TypeBLModel.BLModel_2021)
            {
        ...
        public override void CalkZetaFDM(ref double[] Zeta, double[] tau, double[] tauY = null, double[] P = null, double[][] CS = null)
        {
            try
            {
                ...
                // коррекция ГГУ
                if (Params.BCondIn.typeBC == TypeBoundCond.Dirichlet)
                    Zeta0[0] = Params.BCondIn.valueBC;
                if (Params.BCondOut.typeBC == TypeBoundCond.Dirichlet)
                    Zeta0[N] = Params.BCondOut.valueBC;
                // Расчет деформаций дна от влекомых наносов
                if (Params.blm == TypeBLModel.BLModel_2014 || 
                    Params.blm == TypeBLModel.BLModel_2021)
                {
                ...
                if (Params.BCondIn.typeBC == TypeBoundCond.Neumann || 
                    Params.BCondOut.typeBC == TypeBoundCond.Transit)
                {
                    ...
                    {
                        if (Params.BCondIn.typeBC == TypeBoundCond.Transit)
                        {
                            S[0] = 0;
                        }
                        else
                        {
                            ...
                            S[0] = Params.BCondIn.valueBC - Gtran_in;
                        }
                        AE[0] = AW[1];
                        AP[0] = AW[1];
                    }
                    ...
                    Params.BCondOut.typeBC == TypeBoundCond.Transit)
                {
                    ...
                    else // исток
                    {
                        ...
                        AP[N] = AE[N - 1];
                        AW[N] = AE[N - 1];
                        if (Params.BCondOut.typeBC == TypeBoundCond.Transit)
                            S[N] = 0;
                        else
                            S[N] = -(Params.BCondOut.valueBC - Gtran_out);
                    }
                }
                // Прогонка
        ...
        public static void Test0()
        {
           ...
           // blp.d50 = 0.001;
            ...
            BedLoadFVM_1XD bltask = new BedLoadFVM_1XD(blp);
            int NN = 10;
            double dx = 1.0 / (NN - 1);
        ...
        public static void Test4()
        {
            ...
            LOG.Print("ZetaE: ", ZetaE, 4);
            LOG.Print("ErrorZeta", ErrorZeta, 4);
