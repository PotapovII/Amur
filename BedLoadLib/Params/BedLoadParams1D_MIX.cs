...
namespace BedLoadLib
{
    ...
    /// </summary>
    [Serializable]
    public class BedLoadParams1D_MIX : BedLoadParams1D, ITProperty<BedLoadParams1D_MIX>
    {
        /// <summary>
        ...
        public BedLoadParams1D_MIX() : base()
        {
        ...
        public BedLoadParams1D_MIX(BedLoadParams1D_MIX bmmp) : base(bmmp)
        {
            SetParams(bmmp);
        }
        public void SetParams(BedLoadParams1D_MIX bmmp)
        {
            base.SetParams(bmmp);
            this.Ha = bmmp.Ha;
        ...
        {
            SetParams((BedLoadParams1D_MIX)p);
        }
        public override object GetParams()
        {
            return (BedLoadParams1D_MIX)this;
        }
        ...
        public BedLoadParams1D_MIX Clone(BedLoadParams1D_MIX p)
        {
            return new BedLoadParams1D_MIX(p);
        }
