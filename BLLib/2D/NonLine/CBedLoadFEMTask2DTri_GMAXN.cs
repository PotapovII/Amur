...
namespace BLLib
{
    ...
    /// </summary>
    [Serializable]
    public class CBedLoadFEMTask2DTri_GMAXN : CBedLoadFEMTask2DTri
    {
        /// <summary>
        ...
        {
            return new CBedLoadFEMTask2DTri_GMAXN(new BedLoadParams());
        }
        /// <summary>
        /// Конструктор 
        /// </summary>
        public CBedLoadFEMTask2DTri_GMAXN(BedLoadParams p) : base(p)
        {
