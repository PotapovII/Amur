...
namespace BLLib
{
    ...
    /// </summary>
    [Serializable]
    public class CBedLoadFEMTask2DTri_GMAX : CBedLoadFEMTask2DTri
    {
        /// <summary>
        ...
        {
            return new CBedLoadFEMTask2DTri_GMAX(new BedLoadParams());
        }
        /// <summary>
        /// Конструктор 
        /// </summary>
        public CBedLoadFEMTask2DTri_GMAX(BedLoadParams p) : base(p)
        {
