...
namespace BLLib
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ABedLoadFEMTask2D : ABedLoadTask2D
    {
        /// <summary>
        ...
        /// </summary>
        public ABedLoadFEMTask2D(BedLoadParams p) : base(p)
        {
            InitBedLoad();
            time = 0;
        }
        ...
        public virtual void CreateAlgebra(IAlgebra _algebra = null)
        {
            if (this.algebra == null)
            {
                ...
                //this.algebra = new SparseAlgebraGMRES((uint)mesh.CountKnots, 10, true);
        ...
        public (double int_Z, double int_Z2, double Area) IntZeta(double[] Z)
        {
            ...
            for (uint elem = 0; elem < mesh.CountElements; elem++)
            {
                ...
                sumZ += midleZ * S / 3;
                //Console.WriteLine("S [{0}] = {1:F5} sZ = {5:F5}, z0 ={2:F5} z1 ={3:F5} z2 ={4:F5}", elem, S, ezeta[0], ezeta[1], ezeta[2], esum);
