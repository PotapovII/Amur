...
//    /// </summary>
//    [Serializable]
//    public class CBedLoadTask1XD : ABedLoadTask
//    {
...
//        double MatrixK = 0, MatrixM;
//        double dZetadX, dZetadY, dPX;
//        //double cosA, sinA;
...
//        /// Конструктор 
//        /// </summary>
//        public CBedLoadTask1XD(BedLoadParams p) : base(p)
//        {
//            cu = 3;
//            a = new double[cu];
//            b = new double[cu];
...
//                MEM.Alloc<double>(mesh.CountKnots, ref MRight);
//                algebra.Clear();
//                Ralgebra.Clear();
