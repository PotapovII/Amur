...
namespace BLLib
{
    ...
    /// </summary>
    [Serializable]
    public class SrossSectionalBedLoadStreemTask1D : ABedLoadTask1D
    {
        /// <summary>
        /// Параметр Шильдса
        /// </summary>
        ...
        {
            return new SrossSectionalBedLoadStreemTask1D(new BedLoadParams());
        }
        /// <summary>
        /// Конструктор по умолчанию/тестовый
        /// </summary>
        public SrossSectionalBedLoadStreemTask1D(BedLoadParams p) : base(p)
        {
            InitBedLoad();
