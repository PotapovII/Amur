...
namespace BLLib
{
    ...
    /// </summary>
    [Serializable]
    public class BedLoadTask_1YD : ABedLoadTask1D
    {
        /// <summary>
        /// Параметр Шильдса
        /// </summary>
        ...
        {
            return new BedLoadTask_1YD(new BedLoadParams());
        }
        /// <summary>
        /// Конструктор по умолчанию/тестовый
        /// </summary>
        public BedLoadTask_1YD(BedLoadParams p) : base(p)
        {
            InitBedLoad();
        ...
        public static void Test0()
        {
            ...
            BedLoadTask_1YD bltask = new BedLoadTask_1YD(blp);
            // задача Дирихле
