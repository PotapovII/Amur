...
namespace BLLib
{
    ...
    /// </summary>
    [Serializable]
    public class CBedLoadMixTask1D : ABedLoadTaskMix1D, IBedLoadTask
    {
        public override IBedLoadTask Clone()
        {
            return new CBedLoadMixTask1D(new BedMixModelParams());
        }
        ///// <summary>
        ...
        public CBedLoadMixTask1D(BedMixModelParams p) : base(p)
        {
            InitBedLoad();
            name = "1DX (Mix d_f) деформация дна T(U-Uc_f) МКЭ";
