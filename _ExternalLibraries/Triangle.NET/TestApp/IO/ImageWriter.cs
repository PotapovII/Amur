...
namespace MeshExplorer.IO
{
    ...
    public class ImageWriter
    {
        ...
        public void Export(MeshNet mesh, string filename, int type, int width, bool compress)
        {
            if (type == 1)
            {
        ...
        private void ExportEps(MeshNet mesh, string filename, int width, bool compress)
        {
        ...
        private void ExportSvg(MeshNet mesh, string filename, int width, bool compress)
        {
