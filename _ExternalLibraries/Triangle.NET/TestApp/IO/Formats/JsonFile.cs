    ...
    public class JsonFile : IMeshFile
    {
        ...
        public void Write(IMeshNet mesh, string filename)
        {
            using (StreamWriter writer = new StreamWriter(filename))
            {
                ...
                if (((MeshNet)mesh).CurrentNumbering == NodeNumbering.None)
                {
                    ((MeshNet)mesh).Renumber(NodeNumbering.Linear);
                }
                ...
                {
                    writer.Write(",");
                    WritePoints((MeshNet)mesh, writer, nv);
                }
        ...
        private void WritePoints(MeshNet mesh, StreamWriter writer, int nv)
        {
