...
namespace TriangleNet.IO
{
    ...
    public class TriangleWriter
    {
        ...
        public void Write(MeshNet mesh, string filename)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public void WriteNodes(MeshNet mesh, string filename)
        {
        ...
        /// Number the vertices and write them to a .node file.
        /// </summary>
        private void WriteNodes(StreamWriter writer, MeshNet mesh)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public void WriteElements(MeshNet mesh, string filename)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public void WritePoly(MeshNet mesh, string filename)
        {
        ...
        /// make sure a .node file was written before, so that the nodes 
        /// are numbered right.</remarks>
        public void WritePoly(MeshNet mesh, string filename, bool writeNodes)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public void WriteEdges(MeshNet mesh, string filename)
        {
            ...
            using (var writer = new StreamWriter(filename))
            {
                ...
                foreach (var item in mesh.triangles)
                {
                    ...
                    {
                        tri.Sym(ref trisym);
                        if ((tri.tri.id < trisym.tri.id) || (trisym.tri.id == MeshNet.DUMMY))
                        {
                            p1 = tri.Org();
                            p2 = tri.Dest();
                            ...
                            if (behavior.UseBoundaryMarkers)
                            {
                                ...
                                if (behavior.useSegments)
                                {
                                    ...
                                    if (checkmark.seg.hash == MeshNet.DUMMY)
                                    {
                                ...
                                {
                                    writer.WriteLine("{0} {1} {2} {3}", index, p1.id, p2.id,
                                            trisym.tri.id == MeshNet.DUMMY ? "1" : "0");
                                }
                            }
                            else
                            {
        ...
        public void WriteNeighbors(MeshNet mesh, string filename)
        {
            Otri tri = default(Otri), trisym = default(Otri);
            int n1, n2, n3;
            int i = 0;
