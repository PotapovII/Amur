...
namespace TriangleNet
{
    ...
    /// <summary>
    /// MeshNet data structure.
    /// Структура данных MeshNet.
    /// </summary>
    public class MeshNet : IMeshNet
    {
        #region Variables
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeshNet" /> class.
        /// </summary>
        public MeshNet(Configuration config)
        {
            Initialize();
        ...
        internal void CopyTo(MeshNet target)
        {
        ...
        internal void TransferNodes(IList<Vertex> points)
        {
            ...
            {
                logger.Error("Input must have at least three input vertices.", "MeshNet.TransferNodes()");
        ...
        internal void Flip(ref Otri flipedge)
        {
            ...
            //{
            //    logger.Error("Attempt to flip on boundary.", "MeshNet.Flip()");
            //    flipedge.LnextSelf();
            //    return;
            //}
            ...
            //    {
            //        logger.Error("Attempt to flip a segment.", "MeshNet.Flip()");
            //        flipedge.LnextSelf();
            //        return;
            //    }
            //}
