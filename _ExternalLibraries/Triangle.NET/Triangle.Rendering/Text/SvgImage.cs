...
namespace TriangleNet.Rendering.Text
{
    ...
    public class SvgImage
    {
        ...
        private void DrawTriangles(StreamWriter svg, MeshNet mesh, bool label)
        {
            svg.Write("\t<path d=\"");
        ...
        private void DrawEdges(StreamWriter svg, MeshNet mesh)
        {
            svg.Write("\t<path d=\"");
        ...
        private void DrawSegments(StreamWriter svg, MeshNet mesh)
        {
            svg.Write("\t<path d=\"");
        ...
        private void DrawPoints(StreamWriter svg, MeshNet mesh, bool label)
        {
