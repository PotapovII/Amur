...
namespace TriangleNet.Rendering.GDI
{
    ...
    public class ImageRenderer
    {
        ...
        public static void Save(IMeshNet mesh, string file = null, int width = 800,
        ...
        /// </remarks>
        public Bitmap Render(IMeshNet mesh, int width = 800)
        {
            Bitmap bitmap;
        ...
        private int[] GetRegions(IMeshNet mesh)
        {
            mesh.Renumber();
