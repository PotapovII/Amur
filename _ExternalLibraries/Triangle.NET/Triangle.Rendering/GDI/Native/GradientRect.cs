...
namespace TriangleNet.Rendering.GDI.Native
{
    ...
    /// Структура GRADIENT_RECT определяет индекс двух вершин в
    /// массив pVertex в функции GradientFill. Эти две вершины образуют
    /// верхняя левая и нижняя правая границы прямоугольника.
    /// </summary>
    /// <remarks>
